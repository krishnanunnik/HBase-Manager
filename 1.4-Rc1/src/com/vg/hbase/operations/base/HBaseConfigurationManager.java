...
public class HBaseConfigurationManager {
	...
	private Configuration getConfiguration() {
		...
		config.set("hbase.zookeeper.quorum", HbaseManagerStatic.getHBASE_ZOOKEEPER_QUORUM());
		config.set("hbase.zookeeper.property.clientPort", HbaseManagerStatic.getHBASE_ZOOKEEPER_PROPERTY_CLIENT_PORT());
