...
public class HBaseManagerAdminPanel extends javax.swing.JDialog {
	...
	private HBaseAdmin hbaseAdmin;// = null;//
									// HBaseConfigurationManager.getHbaseAdmin();
	...
	public HBaseManagerAdminPanel(java.awt.Frame parent, boolean modal) {
		...
		hbaseAdmin = HBaseConfigurationManager.getHbaseAdmin();
		addTableList();
		// addTableList();
	...
	private void AddColoumnList(String tblName) {
		...
		String[] familyVersions = HBaseTableManager.getColFamilyVersions(tblName);
	...
	public void setVisible(boolean arg0) {
		...
		/*
		 * if (arg0) { HBaseTableManager.resetConnection(); hbaseAdmin =
		 * HBaseConfigurationManager.getHbaseAdmin(); addTableList(); }
		 */
	...
	private void initComponents() {
		...
		setTitle("HBase Manager - Administrator Panel : Hbase: @" + HbaseManagerStatic.getCurrentConnectionAlias());
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addComponent(jLabel1)).addGroup(jPanel1Layout.createSequentialGroup().addGap(33, 33, 33).addComponent(jLabel2).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(comboTableList, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE).addGap(38, 38, 38).addComponent(jLabel3).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(clickAlter).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(clickDrop).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(clickTruncate))).addContainerGap(21, Short.MAX_VALUE)));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addComponent(jLabel1).addGap(22, 22, 22).addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel2).addComponent(comboTableList, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(jLabel3).addComponent(clickAlter).addComponent(clickDrop).addComponent(clickTruncate)).addContainerGap(39, Short.MAX_VALUE)));

		panelAlterTableControl.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
		...
		panelAlterTableControlLayout.setHorizontalGroup(panelAlterTableControlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(panelAlterTableControlLayout.createSequentialGroup().addContainerGap().addGroup(panelAlterTableControlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(panelAlterTableControlLayout.createSequentialGroup().addComponent(jLabel4).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(labelTableName)).addGroup(panelAlterTableControlLayout.createSequentialGroup().addGroup(panelAlterTableControlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jLabel5).addComponent(jLabel6)).addGap(23, 23, 23).addGroup(panelAlterTableControlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING).addComponent(valueNewColFamilyName, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE).addGroup(panelAlterTableControlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(clickAlterTable).addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE))).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(panelAlterTableControlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(clickAddColFamily).addComponent(clickRemoveColFamily)))).addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		panelAlterTableControlLayout.setVerticalGroup(panelAlterTableControlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(panelAlterTableControlLayout.createSequentialGroup().addGap(24, 24, 24).addGroup(panelAlterTableControlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel4).addComponent(labelTableName)).addGap(18, 18, 18).addGroup(panelAlterTableControlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(valueNewColFamilyName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(clickAddColFamily).addComponent(jLabel5)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addGroup(panelAlterTableControlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addGroup(panelAlterTableControlLayout.createSequentialGroup().addComponent(jLabel6).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(clickRemoveColFamily)).addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)).addGap(37, 37, 37).addComponent(clickAlterTable).addContainerGap(40, Short.MAX_VALUE)));

		javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
		getContentPane().setLayout(layout);
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(panelAlterTableControl, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addGroup(layout.createSequentialGroup().addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addGap(0, 15, Short.MAX_VALUE))).addContainerGap()));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addGap(18, 18, 18).addComponent(panelAlterTableControl, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addContainerGap(38, Short.MAX_VALUE)));
	...
	private void clickAddColFamilyActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (StringUtils.isEmpty(colFamilyName) || StringUtils.containsAny(colFamilyName, splCharArray)) {
			...
			try {
				if (colFamily.length > 1)
					colDesc.setMaxVersions(Integer.parseInt(colFamily[1]));
			}
			catch (Exception e) {
	...
	private void clickAlterActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "Altering table Failed", "Error", JOptionPane.ERROR_MESSAGE);
	...
	private void clickDropActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try {
			int opt = JOptionPane.showConfirmDialog(this, "Are you sure you want to Drop '" + comboTableList.getSelectedItem() + "'", "Warning!", JOptionPane.YES_NO_OPTION);
			if (opt == 0) {
			...
			JOptionPane.showMessageDialog(this, "Table: " + tableName + " drop failed", "Error", JOptionPane.ERROR_MESSAGE);
			Logger.getLogger(HBaseManagerAdminPanel.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
	...
	private void clickTruncateActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try {
			...
			int opt = JOptionPane.showConfirmDialog(this, "This Action will delete all Data of '" + comboTableList.getSelectedItem() + "'. Are you Sure?", "Warning!", JOptionPane.YES_NO_OPTION);
			if (opt == 0) {
				byte[] tableName = Bytes.toBytes((String) comboTableList.getSelectedItem());
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(HBaseManagerAdminPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		}
