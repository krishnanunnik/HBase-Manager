...
public class HbaseManagerTableGetter {
	...
	tblMngr = new HBaseTableManager("new");
    }
    ...
    public static ResultScanner getAllDataInRangeOfFamily(String startRowRange, String stopRowRange, byte[][] cfs,
	    String ctableName) {
    ...
    public static ResultScanner getList(String startRowRange, String stopRowRange, byte[] cf1, byte[] cf2, long limit,
	    FilterList filterList, String ctableName) {
